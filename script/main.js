...
function start() {
    ...
    document.getElementById('title').innerText = 'Chúc em ngày mới vui vẻ nha, ngày càng thêm xinh ^.^'
    ...
    var x = setInterval(function() {
        ...
        if (distance <= 0) {
            clearInterval(x);
            document.getElementById("container").innerHTML = '<h1 style="font-size: 20px;">(^.^) <br> <span style="font-style: italic;font-weight: bold; font-size: 20px; color: #ff007f; font-family: cursive, Comic Sans MS;">😘Đinh Thị Y Hạnh😘</span> </h1>';
